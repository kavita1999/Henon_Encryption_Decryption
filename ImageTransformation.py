...
def pixelManipulation(size,imageName):
    ...
    transformationMatrix = ghm.genTransformationMatrix3(size)
    ...
    im.save("HenonIkedaTransformedImage.bmp", "BMP")
    absPath = os.path.abspath("HenonIkedaTransformedImage.bmp")
    return absPath